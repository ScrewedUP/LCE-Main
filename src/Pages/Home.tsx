        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="flex flex-col justify-center items-center h-full w-full px-4">
              <div className="text-5xl sm:text-5xl md:text-6xl lg:text-6xl text-center w-full md:w-2/3 font-bold ">
                Transforming{" "}
                <span className="text-blue-600">early-stage ideas</span> into{" "}
                <span className="text-orange-500">success</span>{" "}
              </div>
              <div className="mt-4 text-center font-semibold w-full sm:w-3/4 md:w-2/4 text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 font-poppins">
              ...
              <div className="mt-4 text-center">
                <Button
                  variant="secondary"
                  className="font-poppins font-semibold bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base md:text-lg px-4 py-2 md:px-6 md:py-3"
                  onClick={() => {
                    navigate("/register");
                  }}
                >
